  ...
  >
      ...
      >
        <Tooltip.Tooltip>
          <Tooltip.TooltipTrigger as-child>
            <button
              type="button"
              class="text-muted-foreground border-border/60 flex w-full cursor-default flex-col items-center gap-1 rounded-lg border border-transparent px-2 py-2 transition-all"
              :class="
                space.active
                  ? 'bg-accent text-accent-foreground border-border shadow-sm'
                  : 'hover:bg-accent-hover/70 hover:border-border/70'
              "
              @click="navigate"
            >
              <component
    ...
    >
      ...
      <UiText
        ...
        variant="xs"
        weight="medium"
        class="text-muted-foreground/55 font-mono leading-none select-none"
      >
